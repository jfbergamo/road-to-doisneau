...
('/content/photo/L_équipe_de_football_de_la_rue_des_Panoyaux_1936.jpg', 'L équipe de football de la rue des Panoyaux', 'Ménilmontant, Parigi', 'L''infanzia di strada: una squadra di ragazzi posa con orgoglio nel quartiere di Ménilmontant.', 1936),
...
('/content/photo/La_plage_des_Sables_d_Olonne_1959.jpg', 'La plage des Sables d Olonne', 'Vandea, Costa Atlantica', 'Le prime vacanze popolari, tra la sabbia e il desiderio di libertà dei bagnanti sulla costa atlantica.', 1959),
('/content/photo/Le_Baiser_de_l_Hôtel_de_Ville_1950.jpg', 'Le Baiser de l Hôtel de Ville', 'Place de l''Hôtel de Ville, Parigi', 'L''icona suprema dell''amore parigino, uno scatto che ha definito il romanticismo del XX secolo.', 1950),
...
('/content/photo/Le_jardin_de_l_homme_à_la_trompette_1949.jpg', 'Le jardin de l homme à la trompetta', 'Gentilly, Val-de-Marne', 'Note musicali che sembrano fiorire in un piccolo giardino segreto di periferia.', 1949),
...
('/content/photo/Les_ballatte_due_Pierrette_d_Orient_1953.jpg', 'Les ballatte due Pierrette d Orient', 'Cabaret L''Escalier, Parigi', 'L''eleganza e la stravaganza del mondo dello spettacolo e del cabaret parigino.', 1953),
...
('/content/photo/Les_Mains_de_l_industrie_1951.jpg', 'Les Mains de l industrie', 'Officine Renault, Billancourt', 'Un omaggio poetico al lavoro manuale nelle officine Renault di Billancourt.', 1951),
...
('/content/photo/Leschiotsen_laisse_Paris1934.jpg', 'Leschiotsen laisse Paris', 'Pont des Arts, Parigi', 'Piccoli momenti di tenerezza e vita cittadina lungo i boulevard di Parigi.', 1934),
('/content/photo/Madmoiselle_Anita_1951.jpg', 'Madmoiselle Anita', 'Le Petit Châtelet, Parigi', 'La solitudine e il fascino di Anita in un bar di Pigalle, un''icona della notte parigina.', 1951),
('/content/photo/Mariage_de_la_rue_de_l_Arbalète_1951.jpg', 'Mariage de la rue de l Arbalète', 'Quartiere Latino, Parigi', 'Un corteo nuziale attraversa le strade del 5° arrondissement, un momento di gioia collettiva.', 1951),
...
('/content/photo/Theatre_despuces1950.jpg', 'Theatre despuces', 'Saint-Ouen, Mercato delle Pulci', 'Il fascino decadente e vivace del mercato delle pulci di Saint-Ouen.', 1950),
